...
final class Simplifier {
    ...
    @Nullable
    static SimplificationResult simplify(final SymbolicExpression expression) {
        ...
        if ((expression instanceof UnaryExpression unaryExpression) &&
            ...
            final SimplificationResult result = Simplifier.simplify(
        ...
        if (expression instanceof BinaryExpression binaryExpression) {
            ...
            final SimplificationResult left = Simplifier.simplify(binaryExpression.getLeft());
            ...
            if ((left != null) && (right != null)) {
                ...
                return switch (binaryExpression.getOperator()) {
                    case NUMERIC_DIV, NUMERIC_MOD -> Simplifier.handleDivision(
                        binaryExpression,
                        left,
                        leftFirstCount,
                        leftSecondCount,
                    ...
                    case NUMERIC_MUL -> Simplifier.handleMultiplication(
                        left,
                        right,
                        leftFirstIdentifier,
                        leftFirstCount,
                    ...
                    case NUMERIC_ADD, NUMERIC_SUB -> Simplifier.handleSumOrSub(
                        binaryExpression,
                        left,
                        right,
                        leftFirstIdentifier,
